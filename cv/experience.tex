  ...
  \cventry
	...
	{Jan 2021 - Present} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			...
			\item {Extraterrestrial rover and robot mechanical component simulation. Applications/development/validation of SCM (Semi-Emperical Soil Contact Model), SPH (Smoothed Particle Hydrodynamics), and DEM (Discrete Element Method) deformable terrain. Developed the VIPER lunar rover model and the Curiosity mars rover model in the chrono::robot module. Integrated sensor simulation support to provide Lidar/Radar perception data in harsh lunar environment. Funded by NASA to support 2023 VIPER lunar mission.}
		\end{cvitems}
	}
